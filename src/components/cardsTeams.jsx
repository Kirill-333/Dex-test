        ...
        <div className="CardsShow">
            <div  className="cardsShowing">
                ...
                <div className="AddTeam">
                   <Link to='/AddNewTeam'> <Add /> </Link> 
                </div>
            </div>
            <div className="cardsPresenting" >
            
                {cards.length === 0 && (<div className="EmptyHere"> <img src="img/illustration.png" className='EmptyHerePhoto'/> </div>)}  
               
                {/* <h1 className="EmptyHeretext">Empty Here</h1>
                <p className="ContinueCard">Add new teams to continue</p> */}
                <div className="show-cards" >
                    {filteredCountries.map(card => (<div className="card" onClick={() => getTeam(card.id)}>
                        <div>{<img src={`${domain}${card.imageUrl}`} className="card__img"/>}

...
const [error, setError] = useState('d')
  ...
  // const [context, setContext] = useState(store1);
  const auth = useAuth()
  // const true1 = context.isLoaded
  ...
  const sendPassword = (e) => {
    ...
    <p>{errors.login?.message || error }</p>
      ...
      <a href="#" className="password-control"></a>
          ...
          <p className='notaMember'>Not a member yet?
       <Link1 to='/signup' text='signup'/> 
      </p>
      </form>
    </div></div>
      
      <div className='imgSign'><img src='img/Group (1).png' className='imgSign1'/></div>
